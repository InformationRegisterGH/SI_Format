...
namespace InfoRegSI
{
    ...
    public class SI_Format_Test
    {
        ...
        public void SI_Double()
        {
            ...
            ans = InfoReg.SI_Format.Format(val, "G3", "metres", SI_Format.Padding.paddingOnly);
        ...
        public void SI_Float()
        {
            ...
            ans = InfoReg.SI_Format.Format(fval, "G5", "meters", SI_Format.Padding.dashWithPadding);
            Assert.AreEqual("24.765 mega-meters ", ans, false, AssertErrorMsg);
        ...
        public void SI_Decimal()
        {
            ...
            ans = InfoReg.SI_Format.Format(decimal_val, "G21", "grams", SI_Format.Padding.dashWithPadding);
            Assert.AreEqual("1.23456789012345678901 kilo-grams ", ans, false, AssertErrorMsg);
            ans = InfoReg.SI_Format.Format(decimal_val, "G21", "grams", SI_Format.Padding.noPaddingOrDash);
